<script>
    const logos = [
        { name: 'Salesforce', hasCaseStudy: false },
        { name: 'HubSpot', hasCaseStudy: true, caseStudyText: 'CASE STUDY' },
        { name: 'Zendesk', hasCaseStudy: false },
        { name: 'Intercom', hasCaseStudy: true, icon: true, caseStudyText: 'CASE STUDY' },
        { name: 'Slack', hasCaseStudy: true, caseStudyText: 'CASE STUDY' },
        { name: 'Asana', hasCaseStudy: false },
        { name: 'Monday', hasCaseStudy: false },
        { name: 'Pipedrive', hasCaseStudy: false, icon: true },
        { name: 'Freshworks', hasCaseStudy: false },
        { name: 'Zoho', hasCaseStudy: false },
        { name: 'ActiveCampaign', hasCaseStudy: false },
        { name: 'logo_circle', hasCaseStudy: false, isImage: true },
        { name: 'Drift', hasCaseStudy: false, icon: true },
        { name: 'Outreach', hasCaseStudy: false, icon: true },
        { name: 'Gong', hasCaseStudy: false }
    ];
</script>
